              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    // Ensure currentType is one of the valid options
                    final validValue =
                    ...
                    return DropdownButtonFormField<String>(
                      ...
                      items: controller.userTypeOptions
                          .map(
                            (e) => DropdownMenuItem(
                              value: e.capitalizeFirst,
                    ...
                    () => Wrap(
                      ...
                      children: controller.bloodGroupOptions.map((bg) {
                        ...
                        return ChoiceChip(
                          label: Text(bg),
                          selected: isSelected,
                          onSelected: (_) => controller.bloodGroup.value =
                              isSelected ? '' : bg,
                          selectedColor: AppTheme.primaryColor,
                          labelStyle: TextStyle(
                            color: isSelected
                  ...
                  Obx(
                    () => DropdownSearch<Map<String, dynamic>>(
                      ...
                      selectedItem: controller.countries.firstWhereOrNull(
                        (c) =>
                            c['code'] == controller.selectedCountryCode.value,
                      ),
                    ...
                    () => Column(
                      children: [
                        ...controller.educationList.asMap().entries.map(
                          (entry) =>
                              _buildEducationItem(entry.key, entry.value),
                        ),
                        TextButton.icon(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            // Education Type
            Obx(() {
              final currentType = item.educationType.value;
              final validValue = ['school', 'college'].contains(currentType)
                  ? currentType
                  : 'school'; // Default to school if invalid
